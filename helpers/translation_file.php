...
class TranslationFileHelper {
	...
	public function add($original, $translation, $context = '') {
		$key = strlen($context) ? ($context . "\x04" . $original) : $original;
	...
	public function save($filename) {
		...
		// Original strings should be in increasing lexicographical order
